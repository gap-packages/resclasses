...
AbstractHTML     := Concatenation("This package permits doing computations with set-theoretic ",
                                  ...
                                  "In addition, these operations are also supported when one ",
                                  "of the operands is a finite set of ring elements."),
